...
# df_ori = pd.read_csv(dnase_ideas_pybed.fn, sep="\t", header=None)
# df_ori.columns = ["chrom", "start", "end", "state", "state_anno"]
...
# df_outersect = pd.read_csv(tf_ideas_outersect.fn, sep="\t", header=None)
# df_outersect.columns = ["chrom", "start", "end", "state", "state_anno"]
...
# df_sorted_by_tf_count.columns = ["chrom", "start", "end", "state", "state_anno", "tf_counts", "seg_size", "counter"]
...
# final_bound_unbound_df.to_csv(join(output_dir, "final_bound_unbound_site_distribution_for_dnase.bed"), header=True, sep="\t")
...
# total_hepg2_sites = dnase_ideas_pybed.count(); total_hepg2_sites
